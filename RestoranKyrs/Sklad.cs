...
namespace RestoranKyrs
{
    ...
    {
        public string qwZakaz = "select *  from  [dbo].[Zakaz_Prod]";
        ...
        private void Button3_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                {
                    sqlConnect.Open();
                    SqlCommand sqlCommand = new SqlCommand("Zakaz_Prod_Delete", sqlConnect)
                    {
                        CommandType = CommandType.StoredProcedure
                    };
                    sqlCommand.Parameters.AddWithValue("@Id_Prod", textBox1.Text);
